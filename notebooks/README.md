...
This should allow you to directly import `src/adverx` in your notebook.
...
Run `python -m ipykernel install --user --name="adverx"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called adverx should be available in the
