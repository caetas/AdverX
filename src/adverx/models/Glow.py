    ...
    def train_model(self,dataloader, args):
        ...
        for epoch in epoch_bar:
            ...
            if total_loss < best_loss:
                ...
                torch.save(self.state_dict(), os.path.join(models_dir,'Glow', f"Glow_{self.in_machine}_{self.K}_{self.L}_{self.hidden_channels}.pt"))
                self.load_state_dict(torch.load(os.path.join(models_dir,'Glow', f"Glow_{self.in_machine}_{self.K}_{self.L}_{self.hidden_channels}.pt")))
